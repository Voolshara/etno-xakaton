LONGRID = [
    ...
    ["Казань", "Экскурсия по городу!символика", ["Другая легенда утверждает, что гигантский драконоподобный змей всегда сторожил ханские сокровища, и что он и по сей день охраняет спрятанные перед захватом города богатства в потаённых пещерах. Исторически достоверно, что змеи некогда были многочисленны в казанском регионе, но затем число их резко сократилось. ", ""], "", "", 0],
    ...
    ["Казань", "Экскурсия по городу!символика", ["На гербе изображён крылатый барс на фоне красного солнца, он помещен в обрамление из татарского народного орнамента, который расшифровывается как “Татарстан”. Барс - покровитель народа, круглый щит - правовая, экономическая, силовая защищенность граждан республики.", ""], "", "", 0],
...
DBN.create_new_article("Казань", "/kazan", "/img/kazan-gerb.png", "/img/kazan-pre.jpg")
for el in ALL_PARTS:
