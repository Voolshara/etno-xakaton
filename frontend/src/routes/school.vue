<template>
  <div>
    <div v-for="article in articles" :key="article" class="school-container">
      <p>
        {{ article[0] }}
      </p>
    </div>
...
export default {
  data() {
    return {
      articles: [
        [
          "Муниципальное автономное общеобразовательное учреждение «Средняя общеобразовательная школа №61» муниципального образования города Чебоксары – столицы Чувашской Республики (далее школа №61) самая большая школа республики, в которой в настоящее время в 69 классах обучается 1929 учащихся.",
        ],
        [
